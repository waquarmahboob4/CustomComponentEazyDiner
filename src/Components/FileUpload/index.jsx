  ...
  return (
    <>
      <div style={{ display: "flex" ,marginLeft: '10px',marginTop:'15px'}}>
        ...
        <div type="text" className="uploadText">
          Upload Your Files
        </div>
      ...
      {uploadedFile.map((file, ind) => (
        <div className="uploadedFileList" key={ind} >
          <p style={{flex:'100%'}}>{file.name}</p>
          ...
          > */}
           ...
           <svg 
             style={{margin:'16px 0px', color:'red'}} 
            onClick={() => {
              deleteFile(ind);
            }} fill="red" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
	 width="20px" height="18px" viewBox="0 0 482.428 482.429"
	>
<g>
	<g>
